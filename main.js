...
window.addEventListener('DOMContentLoaded', () => {
  ...
  setTimeout(() => {
    ...
    bubble2.setAttribute('position', '0.5 0 -1.25');
    bubble2.setAttribute('animation', 'property: position; to: 0.5 1.3 -1.25; dur: 4500; easing: easeOutQuad; fill: forwards');
  ...
  setTimeout(() => {
    ...
    bubble3.setAttribute('position', '-0.4 0 -1.25');
    bubble3.setAttribute('animation', 'property: position; to: -0.4 1.9 -1.25; dur: 5500; easing: easeOutQuad; fill: forwards');

    bubble3.innerHTML = `
      <a-image src="#bubbleImage" width="0.85" height="0.85">
        <a-text value="I am \n currently doing my \n Masters in \n Computer Science" position="0 0 0.01" align="center" color="black" side="double"
  ...
  setTimeout(() => {
    ...
    bubble4.setAttribute('position', '0.4 0 -1.25');
    bubble4.setAttribute('animation', 'property: position; to: 0.4 1.3 -1.25; dur: 4500; easing: easeOutQuad; fill: forwards');

    bubble4.innerHTML = `
      <a-image src="#bubbleImage" width="1" height="1">
        <a-text value="I aim to \n create real-time, \n multimodal interfaces \n that support human \n creativity, well-being \n & autonomy." 
                position="0 -0.05 0.01" align="center" color="black" side="double" shader="msdf" scale ="0.4 0.4 0.4"
                font="https://cdn.jsdelivr.net/gh/etiennepinchon/aframe-fonts/fonts/roboto/Roboto-Regular.json">
        </a-text>
      </a-image>
    `;
  ...
  setTimeout(() => {
    ...
    bubble5.setAttribute('animation', 'property: position; to: 0 2.2 -1.25; dur: 6000; easing: easeOutQuad; fill: forwards');
  ...
  setTimeout(() => {
    ...
    bubble5a.setAttribute('position', '-0.7 0 -1.25');
    bubble5a.setAttribute('animation', 'property: position; to: -0.7 1.7 -1.25; dur: 5000; easing: easeOutQuad; fill: forwards');

    bubble5a.innerHTML = `
      <a-image src="#bubbleImage" width="0.8" height="0.8">
        <a-text value="developing \n intelligent, context \n aware AI systems  " position="0 -0.05 0.01" align="center" color="black" side="double"
                shader="msdf" scale ="0.37 0.37 0.37"
                font="https://cdn.jsdelivr.net/gh/etiennepinchon/aframe-fonts/fonts/roboto/Roboto-Regular.json">
        </a-text>
      </a-image>
    `;
  ...
  setTimeout(() => {
    ...
    bubble5b.setAttribute('position', '0.7 0 -1.25');
    bubble5b.setAttribute('animation', 'property: position; to: 0.7 1.5 -1.25; dur: 5000; easing: easeOutQuad; fill: forwards');
  ...
  setTimeout(() => {
    ...
    bubble5c.setAttribute('position', '-0.1 0 -1.25');
    bubble5c.setAttribute('animation', 'property: position; to: -0.1 1 -1.25; dur: 4000; easing: easeOutQuad; fill: forwards');
  ...
  setTimeout(() => {
    ...
    bubble6.setAttribute('animation', 'property: position; to: 0 2.2 -1.25; dur: 6000; easing: easeOutQuad; fill: forwards');

    bubble6.innerHTML = `
      <a-image src="#bubbleImage" width="0.7" height="0.7">
        <a-text value="I enjoy \n working in" position="0 -0.05 0.01" align="center" color="black" side="double"
                shader="msdf" scale = " 0.5 0.5 0.5"
                font="https://cdn.jsdelivr.net/gh/etiennepinchon/aframe-fonts/fonts/roboto/Roboto-Regular.json">
        </a-text>
      </a-image>
    `;
  ...
  setTimeout(() => {
    ...
    bubble6a.setAttribute('animation', 'property: position; to: -0.2 1.5 -1.25; dur: 6000; easing: easeOutQuad; fill: forwards');
  ...
  setTimeout(() => {
    ...
    bubble6b.setAttribute('position', '0.8 0 -1.25');
    bubble6b.setAttribute('animation', 'property: position; to: 0.8 1.7 -1.25; dur: 6000; easing: easeOutQuad; fill: forwards');
  ...
  setTimeout(() => {
    ...
    bubble6c.setAttribute('position', '-0.7 0 -1.25');
    bubble6c.setAttribute('animation', 'property: position; to: -0.7 1.7 -1.25; dur: 5000; easing: easeOutQuad; fill: forwards');
  ...
  setTimeout(() => {
    ...
    bubble6d.setAttribute('animation', 'property: position; to: 0.2 1.1 -1.25; dur: 5000; easing: easeOutQuad; fill: forwards');
  ...
  setTimeout(() => {
    ...
    bubble6e.setAttribute('position', '-0.6 0 -1.25');
    bubble6e.setAttribute('animation', 'property: position; to: -0.6 1 -1.25; dur: 5000; easing: easeOutQuad; fill: forwards');
  ...
  setTimeout(() => {
    ...
    bubble6f.setAttribute('position', '0.9 0 -1.25');
    bubble6f.setAttribute('animation', 'property: position; to: 0.9 0.85 -1.25; dur: 5000; easing: easeOutQuad; fill: forwards');
  ...
  setTimeout(() => {
    ...
    bubble7.setAttribute('animation', 'property: position; to: 0 2.2 -1.25; dur: 6000; easing: easeOutQuad; fill: forwards');

    bubble7.innerHTML = `
      <a-image src="#bubbleImage" width="0.7" height="0.7">
        <a-text value="I enjoy \n creating \n using" position="0 -0.1 0.01" align="center" color="black" side="double"
                shader="msdf" scale = " 0.5 0.5 0.5"
                font="https://cdn.jsdelivr.net/gh/etiennepinchon/aframe-fonts/fonts/roboto/Roboto-Regular.json">
        </a-text>
      </a-image>
  ...
  setTimeout(() => {
    ...
    bubble7a.setAttribute('animation', 'property: position; to: -0.2 1.5 -1.25; dur: 6000; easing: easeOutQuad; fill: forwards');
  ...
  setTimeout(() => {
    ...
    bubble7b.setAttribute('position', '0.8 0 -1.25');
    bubble7b.setAttribute('animation', 'property: position; to: 0.8 1.7 -1.25; dur: 6000; easing: easeOutQuad; fill: forwards');
  ...
  setTimeout(() => {
    ...
    bubble7c.setAttribute('position', '-0.7 0 -1.25');
    bubble7c.setAttribute('animation', 'property: position; to: -0.7 1.7 -1.25; dur: 5000; easing: easeOutQuad; fill: forwards');
  ...
  setTimeout(() => {
    ...
    bubble7d.setAttribute('animation', 'property: position; to: 0.2 1.1 -1.25; dur: 5000; easing: easeOutQuad; fill: forwards');
  ...
  setTimeout(() => {
    ...
    bubble7e.setAttribute('position', '-0.6 0 -1.25');
    bubble7e.setAttribute('animation', 'property: position; to: -0.6 1 -1.25; dur: 5000; easing: easeOutQuad; fill: forwards');
  ...
  setTimeout(() => {
    ...
    bubble7f.setAttribute('position', '0.9 0 -1.25');
    bubble7f.setAttribute('animation', 'property: position; to: 0.9 0.85 -1.25; dur: 5000; easing: easeOutQuad; fill: forwards');

    bubble7f.innerHTML = `
      <a-image src="#bubbleImage" width="0.6" height="0.6">
        <a-text value="The terminal \n :P" position="0 -0.1 0.01" align="center" color="black" side="double"
                shader="msdf" scale = " 0.4 0.4 0.4"
                font="https://cdn.jsdelivr.net/gh/etiennepinchon/aframe-fonts/fonts/roboto/Roboto-Regular.json">
        </a-text>
      </a-image>
